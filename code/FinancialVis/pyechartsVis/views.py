...
CurrentConfig.GLOBAL_ENV = Environment(
    loader=FileSystemLoader("./pyechartsVis/templates/pyechartsVis"))


# Create your views here.

# def themeRiverVis(request):
#     x_data = ["Finance", "Realty", "Stocks", "Education", "Science",
#               "Society", "Politics", "Sports", "Game", "Entertainment"]
#     data = pd.read_csv("./static/data/fyp_test.csv")
